...
<body>
    ...
    <div class="sidebar">
        <div class="user-welcome">
            ...
            <a href="logout.php" class="btn-logout">➡ Đăng xuất tài khoản</a>
        </div>
    ...
    <div class="main-content">
        <h2>Bảng <?php echo $config['title']; ?></h2>
    ...
    <div class="action-bar">
        <h3>Thao tác</h3>
        <button class="btn btn-add" onclick="openAddModal('<?php echo $pk_field; ?>')"> Thêm dữ liệu mới</button>
        <button class="btn btn-edit" id="btnEdit" onclick="openEditModal()"> Sửa dữ liệu</button>
        <button class="btn btn-delete" id="btnDelete" onclick="deleteRecord()"> Xóa dữ liệu</button>
    </div>
